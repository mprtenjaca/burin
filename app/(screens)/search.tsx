...
import { Bookmark, BookmarkCheck, History, X } from "lucide-react-native";
  ...
  return (
    <View className="flex-row items-center px-4">
      ...
      */}
      ...
      >
        <Text
          className={`font-grotesk-medium text-[17px] ${
      ...
      {/* Temperatura iz burin:last-weather — bez ijednog novog upita. */}
      {temp !== undefined && (
...
export default function SearchScreen() {
  ...
  /** "Vidi više" iz ladice šalje focus=0 — lista gradova bez tipkovnice. */
  ...
  return (
    ...
    >
      ...
      {selected === null && saved.length === 0 && query.length === 0 && (
        <Text className="text-center font-grotesk-medium text-[15px] text-ink/65 dark:text-paper/65">
            ...
            <View key={`${place.id}-${i}`}>
              ...
              <PlaceRow
                ...
                action={
                  ...
                  >
                    {isSaved(place.id) ? (
                      <BookmarkCheck size={22} strokeWidth={2} color={ACCENT_CORAL} />
                    ) : (
      ...
      */}
            ...
            {olderHistory.map((place, i) => (
              <View key={place.id}>
                ...
                <PlaceRow
                  ...
                  onOpen={() => open(place)}
                  action={
                    <History size={19} strokeWidth={2} color={fg} opacity={0.35} />
                  }
                />
              </View>
            ))}
      ...
      {history.length > 0 && (
        ...
        >
          <Text className="font-grotesk-medium text-[14px] text-ink/55 dark:text-paper/55">
